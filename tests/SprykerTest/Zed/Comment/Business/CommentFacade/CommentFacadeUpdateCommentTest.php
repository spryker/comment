...
class CommentFacadeUpdateCommentTest extends Unit
{
    ...
    /**
     * @uses \Spryker\Zed\Comment\Business\Validator\CommentValidator::COMMENT_MESSAGE_MAX_LENGTH
     *
     * @var int
     */
    ...
    /**
     * @uses \Spryker\Zed\Comment\Business\Validator\CommentValidator::GLOSSARY_KEY_COMMENT_INVALID_MESSAGE_LENGTH
     *
     * @var string
     */
